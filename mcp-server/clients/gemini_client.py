...
Provides:
- GeminiCLI: Wrapper for Gemini CLI web search (subprocess)
...
class GeminiCLI:
    """
    Wrapper for Gemini CLI web search.
    
    Invokes the `gemini` CLI tool via subprocess for web searches.
    """
    ...
    def __init__(self, cli_path: str | None = None):
        ...
        Args:
            cli_path: Path to gemini CLI (defaults to 'gemini' in PATH)
        """
        self.cli_path = cli_path or config.gemini.cli_path
    
    async def search(self, query: str) -> WebSearchResult:
        """
        Perform a web search using Gemini CLI.
        
        Args:
            query: Search query
            
        Returns:
            WebSearchResult with search response
        """
        ...
        return WebSearchResult(result=stdout.decode().strip())
...
class GeminiFileSearch:
    ...
    async def create_store(self, name: str) -> FileStoreResult:
        """
